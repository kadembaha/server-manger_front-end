...
import { CustomerResponse } from '../interface/custom-response';
...
export class ServerService {
  ...
  servers$ = <Observable<CustomerResponse>>
   this.http.get<CustomerResponse>(`${this.apiUrl}/server/list`)
  .pipe(
    tap(console.log),
  ...
  save$ =(server : Server) => <Observable<CustomerResponse>>
   this.http.post<CustomerResponse>(`${this.apiUrl}/server/save`,server)
  .pipe(
    tap(console.log),
    catchError(this.handleError)    
  );
  ...
  ping$ =(ipAddress: string) => <Observable<CustomerResponse>>
   this.http.get<CustomerResponse>(`${this.apiUrl}/server/ping/${ipAddress}`)
  .pipe(
    tap(console.log),
    catchError(this.handleError)    
  );
  ...
  delete$ =(serverId : number) => <Observable<CustomerResponse>>
   this.http.delete<CustomerResponse>(`${this.apiUrl}/server/delete/${serverId}`)
  .pipe(
    tap(console.log),
    catchError(this.handleError)    
  );
